//
//  InspirationDetailLayout.swift
//  BuckIt2
//
//  Created by Eric Andersen on 10/26/18.
//  Copyright © 2018 DunDak, LLC. All rights reserved.
//

import UIKit

class InspirationDetailLayout: UICollectionViewFlowLayout {
    
    override var collectionViewContentSize : CGSize {
        // Only support single section for now.
        // Only support Horizontal scroll
        let count = self.collectionView?.dataSource?.collectionView(self.collectionView!, numberOfItemsInSection: 1)
