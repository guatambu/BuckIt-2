...
=======
    static let maggie = User(uid: "01", email: "maggie@email.com", username: "TotsMcGoats", isPrivate: true, firstName: "Margaret", lastName: "Thompson", mockProfilePic: UIImage(named: "maggie"), location: "earth", age: "30")
    
    static let rodrigo = User(uid: "02", email: "rodrigo@email.com", username: "rodrigo31", isPrivate: false, firstName: "Rodrigo", lastName: "Santoro", mockProfilePic: UIImage(named: "rodrigo"), location: "Venezuela", age: "19")
    
    static let dylon = User(uid: "03", email: "dylon@email.com", username: "dylonjefferson", isPrivate: true, firstName: "Dylon", lastName: "Jefferson", mockProfilePic: UIImage(named: "dylon"), location: "Washington", age: "25")
    
    static let luisa = User(uid: "04", email: "luisa@email.com", username: "luluu", isPrivate: false, firstName: "Luisa", lastName: "Morães da Silva", mockProfilePic: UIImage(named: "luisa"), location: "São Paulo, São Paulo, Brasil", age: "35")
...
>>>>>>> 27a70769dba3b5c1b79f197c274523f0089556f5
